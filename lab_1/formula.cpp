...
/****************************************************************************************
 * Реализация базовых функций для работы с формулами.
 *
 * Здесь находятся только простые служебные операции:
 * - определение типа символа;
 * - поиск и добавление переменных;
 * - работа с обычными char-массивами.
 ****************************************************************************************/
