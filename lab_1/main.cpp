 ...
 *
 * Вариант 5:
 * Проверить, следует ли формула из заданной формулы сокращённого языка логики
 * высказываний.
 *
 * Программа работает со следующим алфавитом:
 * A-Z  — пропозициональные переменные;
 * 0, 1 — логические константы;
 * -    — отрицание;
 * /\   — конъюнкция;
 * \/   — дизъюнкция;
 * ->   — импликация;
 ...
 * (, ) — скобки.
 *
 * Программа не завершает работу при некорректном вводе формулы,
 * а сообщает об ошибке и предлагает ввести формулу заново.
 ****************************************************************************************/
